...
export interface paths {
  ...
  "/items/page_sections": {
    /**
     * List Items
     * @description List the page_sections items.
     */
    get: operations["readItemsPageSections"];
    /**
     * Create an Item
     * @description Create a new page_sections item.
     */
    post: operations["createItemsPageSections"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing page_sections items.
     */
    delete: operations["deleteItemsPageSections"];
    /**
     * Update Multiple Items
     * @description Update multiple page_sections items at the same time.
     */
    patch: operations["updateItemsPageSections"];
  };
  "/items/page_sections/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single page_sections item by unique identifier.
     */
    get: operations["readSingleItemsPageSections"];
    /**
     * Delete an Item
     * @description Delete an existing page_sections item.
     */
    delete: operations["deleteSingleItemsPageSections"];
    /**
     * Update an Item
     * @description Update an existing page_sections item.
     */
    patch: operations["updateSingleItemsPageSections"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsPages: {
      ...
      date_updated?: string | null;
      title?: string | null;
      screenshot?: string | components["schemas"]["Files"] | null;
      sections?: ((string | components["schemas"]["ItemsPageSections"])[]) | null;
    };
    ItemsPageSections: {
      /** Format: uuid */
      id?: string;
      ...
      /** Format: timestamp */
      date_updated?: string | null;
      page_id?: string | components["schemas"]["ItemsPages"] | null;
      order?: number | null;
...
export interface operations {
  ...
  readItemsPageSections: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsPageSections"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsPageSections: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsPageSections"][] | components["schemas"]["ItemsPageSections"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsPageSections: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsPageSections"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type ApiCollections = {
  ...
  page_sections: components["schemas"]["ItemsPageSections"][];
};
